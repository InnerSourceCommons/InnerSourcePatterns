...
* SAP implemented the Gig Marketplace pattern. A new InnerSource program got added to its internal job platform where positions and similar offerings can be posted. 
