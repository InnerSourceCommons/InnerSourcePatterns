...
- Flutter Entertainment define an "[Inner Source Pyramid](https://innersource.flutter.com/how/)" to define 3 different InnerSource models: Readable Source, Guest Contributions and Maintainers in Multiple Teams. Each name is centrally documented. The use of these names is encouraged via repeated usage, direct training and categorisation of each InnerSource project.
