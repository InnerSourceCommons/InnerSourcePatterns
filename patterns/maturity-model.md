...
Teams believe that "it's all about migrating to a shared software development forge".
...
Prior to adopting InnerSource as a working model, teams are aware of the practices that are expected of them - both in the short term as well as in the long term.
