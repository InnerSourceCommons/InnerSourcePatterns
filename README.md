...
* [Standardized Release Process](patterns/2-structured/release-process.md) - *Teams are reluctant to use InnerSource projects that they are unfamiliar with when they are unclear about the release process. Providing clear release notes and a published artifact gives people confidence you are publishing a quality product.*
